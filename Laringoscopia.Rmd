...
<div align="justify">
Este document fue creado con el propósito de insentivar el uso de software libre estadístico para el desarrollo de ensayos clínicos, para los profesionales en el área de la salud y estadísticos.
Se asume conocimiento previo de primer nivel de bioestadística.
</div>
...
```{r figura2, echo=FALSE, out.width="20%", fig.cap="Macintosh hoja #4", fig.align = 'center'}
...
<div align="justify">
En el siguiente video se muestra una representación del procedimiento de intubación de pacientes, realizado con ambos métodos. Apatir del tiempo 6:22 min se encuentra el 
</div>
...
<div align="justify">
El resultado primario es el tiempo total de la intubación que se definió como el tiempo desde el inicio del primer intento de inserción del laringoscopio hasta obtener señal de capnograma, la cual dentro del codigo se referencia como `Tiempo_total_intubacion`. Si un intento con el dispositivo asignado falla, entonces otro intento ó una técnica alterna se utilizó. La intubación usando el método asignado dentro de los 100 segundos independientemente del número de intentos se consideró exitoso. 
